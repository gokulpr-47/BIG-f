...
class UserRepository {
  async CreateUser({  firstname, lastname,sem, gradYear, branch, college, password, username }) {
    try {
      const user = new userModel({firstname, lastname,sem, gradYear, branch, college, password, username });
      await user.save();
