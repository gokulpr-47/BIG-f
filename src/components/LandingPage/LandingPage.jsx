      ...
      <div className="lpdowndiv">
          ...
          <Fade left>
            ...
            <div className="orangediv">
              ...
              <div className="heading">
                <h1>BIG-f<strong>.</strong> </h1>
              </div>
              <div className="abtus">
                <img src="\images\Component 2.svg" alt="" className="abtsusimg" />
              </div>
              ...
              <div className="allcontainer">
                ...
                <div className="arrow">
                  <img src="\images\Component 3.svg" alt="" className="arrowsign" />
                </div>
        ...
        <div className="lpdownright">
          ...
          <div className="imgss">
            ...
            <Fade right><img src="\images\card.svg" alt="" className="img2" /> </Fade>
            <Fade right><img src="\images\card.svg" alt="" className="img3" /> </Fade>
            <Fade right><img src="\images\card.svg" alt="" className="img4" /></Fade>
          </div>
        </div>
      </div>
    </div>
